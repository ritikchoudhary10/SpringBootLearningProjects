...
public class Application {
	 ...
	 * 											we take the support of properties file
	 * 
	 * @Bean DataSource getDs() throws Exception{ ComboPooledDataSource ds = new
	 * ComboPooledDataSource();
	 * ds.setDriverClass("oracle.jdbc.driver.OracleDriver");
	 * ds.setJdbcUrl("jdbc:oracle:thin:@Personal:1521:orcl");
	 * ds.setUser("c##ritik"); ds.setPassword(null); return ds; }
	 */ 
